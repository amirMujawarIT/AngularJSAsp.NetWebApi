...
myApp.constant('serviceBasePath', 'http://localhost:49488');
//controllers
...
myApp.factory('dataService', ['$http', 'serviceBasePath', 'userService', function ($http, serviceBasePath, userService) {
    ...
    fac.GetAuthenticateData = function () {
        return $http({
            ...
            data: { username: 'tusharit25@gmail.com', password: 'Tushar#123', grant_type: 'password' }
        ...
        /*return $http.get(serviceBasePath + '/Token?').then(function (response) {
            console.log(response);
